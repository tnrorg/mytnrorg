...
export const MESSAGE_DEFAULTS = {
  founder:   { key: 'founder',   heading: 'Founder’s Message',   designation: 'Founder',           sort_order: 1 },
  president: { key: 'president', heading: 'President’s Message', designation: 'Central President', sort_order: 2 },
};
