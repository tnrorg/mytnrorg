...
export const REQUIRED_LABELS = {
  ...
  cnic_front_data: 'CNIC front', cnic_back_data: 'CNIC back',
...
export const FIELD_SECTION = {
  ...
  cnic_front_data: 'V', cnic_back_data: 'V',
...
export function validateApplication(f = {}) {
  ...
  // The CNIC number itself is not collected — the images carry it, and asking
  // an applicant to type a national ID number adds a transcription error to
  // every application for no gain. The committee reads it off the card.
  //
