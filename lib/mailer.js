...
/**
 * @param {object} o
 * @param {Array}  [o.attachments]  nodemailer attachments — used by meeting
 *                                  invitations to carry the .ics calendar
 *                                  entry. Optional and additive: every
 *                                  existing caller is unaffected.
 */
export async function sendNotice({ to, subject, heading, body, ctaText, ctaUrl, attachments }) {
